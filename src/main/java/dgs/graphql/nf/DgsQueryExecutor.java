...
public interface DgsQueryExecutor {
     ...
     *                   This is made available in the {@link nf.graphql.dgs.internal.DgsRequestData} object on {@link }com.netflix.graphql.dgs.context.DgsContext}.
     * @return Returns a GraphQL {@link ExecutionResult}. This includes data and errors.
     * @see <a href="https://graphql.org/learn/queries/#variables">Query Variables</a>
     */
     ...
     * @param query         The query string
     * @param variables     A map of variables
     * @param extensions    A map representing GraphQL extensions. This is made available in the {@link nf.graphql.dgs.internal.DgsRequestData} object on {@link com.netflix.graphql.dgs.context.DgsContext}.
     ...
     * @see <a href="https://github.com/json-path/JsonPath">JsonPath syntax docs</a>
     */
    <T> T executeAndExtractJsonPath(String query, String jsonPath, ServletWebRequest servletWebRequest);
